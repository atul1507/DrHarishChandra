  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 space-y-6 sm:space-y-8">
      ...
      <div className="bg-white rounded-lg border-2 border-[#F9C97C] shadow-sm overflow-hidden">
        <h2 className="text-xl sm:text-2xl font-bold text-[#F9A825] px-3 sm:px-4 py-3 bg-gray-50">
          Ph.D. Awarded
        </h2>
          ...
          <table className="w-full text-sm sm:text-base">
            <thead>
              <tr className="bg-[#F9C97C]">
                ...
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Name</th>
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Reg. No.</th>
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Thesis Title</th>
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Awarded Date</th>
              </tr>
            </thead>
            <tbody>
          ...
          <table className="w-full text-sm sm:text-base">
            <thead>
              <tr className="bg-[#F9C97C]">
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">S.No.</th>
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Name</th>
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Roll No.</th>
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Dissertation Title</th>
              </tr>
            </thead>
            <tbody>
