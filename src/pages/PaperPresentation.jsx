          ...
          <table className="w-full text-sm sm:text-base">
            <thead>
              <tr className="bg-[#F9C97C]">
                ...
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Paper Title</th>
                ...
                <th className="px-3 sm:px-4 py-2 sm:py-3 text-left font-semibold text-black">Status</th>
              </tr>
            </thead>
            <tbody>
